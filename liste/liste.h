 ...
 * ---------------------------------------------------
 * list 	: liste (node_t *)
 * valeur	: valeur � mettre � la queue de la liste
...
//lire ou �crire la donn�e d'un noeud
...
//donn�e dans la liste, retourne la tete de liste
node_t * list_headRemove(node_t * head);
//suppression de la tete de liste
//retourne la nouvelle tete de liste
void list_destroy(node_t * head);
//destruction d'une liste
//(la lib�ration des donn�es n'est pas prise en charge
